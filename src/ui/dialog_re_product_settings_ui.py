# Form implementation generated from reading ui file '/Volumes/KINGSTON/Dev/python/python.my-manager.v1/ui/dialog_re_product_settings.ui'
#
...
"}")
        ...
        self.create_btn = QtWidgets.QPushButton(parent=self.basic_setting_container)
        ...
        self.create_btn_2 = QtWidgets.QPushButton(parent=self.image_dir_setting_container)
        self.create_btn_2.setObjectName("create_btn_2")
        self.horizontalLayout_7.addWidget(self.create_btn_2)
        ...
        self.delete_btn.setStyleSheet("background-color: none;")
        ...
        Dialog_REProductSettings.setTabOrder(self.name_vi_input, self.create_btn)
    ...
    def retranslateUi(self, Dialog_REProductSettings):
        ...
        self.create_btn_2.setText(_translate("Dialog_REProductSettings", "Add new"))
