...
class Ui_ProductRealEstate(object):
    def setupUi(self, ProductRealEstate):
        ProductRealEstate.setObjectName("ProductRealEstate")
        ProductRealEstate.resize(1139, 519)
        font = QtGui.QFont()
        ...
        self.contents_container_w = QtWidgets.QWidget(parent=ProductRealEstate)
        ...
        self.line = QtWidgets.QFrame(parent=ProductRealEstate)
        self.line.setFrameShape(QtWidgets.QFrame.Shape.VLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        self.line.setObjectName("line")
        self.horizontalLayout_5.addWidget(self.line)
        self.details_container_w = QtWidgets.QWidget(parent=ProductRealEstate)
        ...
        self.retranslateUi(ProductRealEstate)
        QtCore.QMetaObject.connectSlotsByName(ProductRealEstate)

    def retranslateUi(self, ProductRealEstate):
        _translate = QtCore.QCoreApplication.translate
        ProductRealEstate.setWindowTitle(
            _translate("ProductRealEstate", "Form"))
        self.furniture_label.setText(
            _translate("ProductRealEstate", "Công năng"))
        ...
        self.options_label.setText(_translate(
            "ProductRealEstate", "Loại hình kinh doanh"))
        self.options_input.setItemText(
            0, _translate("ProductRealEstate", "Tất cả"))
        self.categories_label.setText(_translate(
            "ProductRealEstate", "Danh mục bất động sản"))
        self.categories_input.setItemText(
            0, _translate("ProductRealEstate", "Tất cả"))
        self.building_line_s_label.setText(
            _translate("ProductRealEstate", "Lộ giới"))
        self.building_line_s_input.setItemText(
            0, _translate("ProductRealEstate", "Tất cả"))
        self.furniture_s_lable.setText(
            _translate("ProductRealEstate", "Nội thất"))
        ...
        self.legal_s_input.setItemText(
            0, _translate("ProductRealEstate", "Tất cả"))
        self.pid_label.setText(_translate("ProductRealEstate", "PID"))
        self.street_label.setText(_translate("ProductRealEstate", "Tên đường"))
        self.area_label.setText(_translate("ProductRealEstate", "Diện tích"))
        self.price_label.setText(_translate("ProductRealEstate", "Giá"))
        self.structure_label.setText(
            _translate("ProductRealEstate", "Kết cấu"))
        self.action_create_btn.setText(
            _translate("ProductRealEstate", "Create new"))
        self.action_upload_btn.setText(
            _translate("ProductRealEstate", "Upload"))
        self.action_download_btn.setText(
            _translate("ProductRealEstate", "Download"))
        self.image_label.setText(_translate("ProductRealEstate", "Images"))
        self.action_default_btn.setText(
            _translate("ProductRealEstate", "Default"))
        self.action_random_btn.setText(
            _translate("ProductRealEstate", "Random"))
