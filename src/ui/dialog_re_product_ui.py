...
"}")
        ...
        Dialog_REProduct.setTabOrder(self.option_sell_radio, self.option_rent_radio)
        Dialog_REProduct.setTabOrder(self.option_rent_radio, self.option_assignment_radio)
        Dialog_REProduct.setTabOrder(self.option_assignment_radio, self.pid_input)
        Dialog_REProduct.setTabOrder(self.pid_input, self.statuses_combobox)
        Dialog_REProduct.setTabOrder(self.statuses_combobox, self.categories_combobox)
    ...
    def retranslateUi(self, Dialog_REProduct):
        ...
        self.option_rent_radio.setText(_translate("Dialog_REProduct", "Cho thuê"))
        self.option_assignment_radio.setText(_translate("Dialog_REProduct", "Sang nhượng"))
        ...
        self.statuses_combobox.setItemText(0, _translate("Dialog_REProduct", "Trạng thái"))
