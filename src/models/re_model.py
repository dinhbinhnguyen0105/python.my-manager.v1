...
class REProductModel(QSqlRelationalTableModel):
    ...
    def _set_relations(self):
        ...
        self.setRelation(
            ...
            QSqlRelation(constants.RE_SETTING_PROVINCES_TABLE,
                         "id", "label_vi"),
        )
        self.setRelation(
            self.fieldIndex("district_id"),
            QSqlRelation(constants.RE_SETTING_DISTRICTS_TABLE,
                         "id", "label_vi"),
        )
        self.setRelation(
        ...
        self.setRelation(
            ...
            QSqlRelation(constants.RE_SETTING_CATEGORIES_TABLE,
                         "id", "label_vi"),
        )
        self.setRelation(
            self.fieldIndex("building_line_id"),
            QSqlRelation(constants.RE_SETTING_BUILDING_LINE_S_TABLE,
                         "id", "label_vi"),
        )
        self.setRelation(
            self.fieldIndex("legal_id"),
            QSqlRelation(constants.RE_SETTING_LEGAL_S_TABLE, "id", "label_vi"),
        )
        self.setRelation(
            self.fieldIndex("furniture_id"),
            QSqlRelation(constants.RE_SETTING_FURNITURE_S_TABLE,
                         "id", "label_vi"),
        )
